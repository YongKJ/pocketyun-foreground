...
export default {
  ...
  methods: {
    ...
    getUsersInfo: function() {
      this.$axios.post('http://' + this.baseHost + '/pocketyun/userController/getUsers', this.$qs.stringify({
...
//         console.log(this.users);
    ...
    deleteUser:function(name) {
      ...
      this.$confirm('提示：确定删除用户 [' + name + ']？', '删除用户', {
        ...
        this.$axios.post('http://' + this.baseHost + '/pocketyun/userController/delUser', this.$qs.stringify({
          userName: name
        })).then((response) => {
